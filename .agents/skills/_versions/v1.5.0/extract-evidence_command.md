...
**climate_risk / nbs_effect / priority_need are DEFERRED (2026-09) — do NOT emit them.** T3/T6 are
removed from the extraction exercise (archive + restore path: `schema/registers/_deferred/README.md`);
hazard-mitigation, effect/cost and priority material is simply not extracted — never relabel it into a live role;
