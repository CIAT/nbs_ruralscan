...
- **Data Schema (v0.2.2)** — the T0–T7 ERD, field-level spec, evidence/config registers, and draft-0 example tables (structure frozen + machine-validated)
...
| `schema/` | `spec.md` (v0.2.2: T0–T7 + evidence/config registers SRC·EV·VONT·FAM·BIND), `structure/columns.json` (frozen column manifest), ERD, dedup notes, draft-0 example tables (CSV+JSON) for 2 NbS |
